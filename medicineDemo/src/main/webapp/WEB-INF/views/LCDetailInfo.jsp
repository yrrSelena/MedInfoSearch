...
<nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="wrapper wrapper-content">
            <div class="container">
                <br/>
                <h1 class="text-center "><strong>液相色谱法——${CNName}</strong></h1>
                <br/><br/>
                <div class="row">
                            ...
                            <div class="ibox-content">
                                ...
                                <div class="row">
                                    <div class="col-lg-10 col-lg-offset-1">
                                        ...
                                        <div class="col-lg-6">
                                            <table class="table" >
                                                ...
                                                <tr>
                                                    <th width="30%">【发射波长】</th>
                                                    <td>
                                                        <span class="attr_value">${LCInfo.emissionWL}</span>
                                                ...
                                                <tr>
                                                    <th width="30%">【色谱柱】</th>
                                                    <td>
                                                        ${LCInfo.chromatographicCol}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th width="30%">【柱温】</th>
                                                    <td>
                                                        ${LCInfo.colTemperature}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th width="30%">【流动相】</th>
                                                ...
                                                <tr>
                                                    <th width="30%">【进样量】</th>
                                                    <td>
                                                        ${LCInfo.injectionVolume}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th width="30%">【前处理方法】</th>
                                                    <td>
                                                        ${LCInfo.pretreatmentMethod}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th width="30%">【检出限】</th>
                                                    <td>
                                                        ${LCInfo.detectionLimit}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th width="30%">【样品】</th>
                                        ...
                                        <div class="col-lg-5">
                                            <%--<ul id="imglist">--%>
                                                <%--<li> </li>--%>
                                                    <img id="spectrogram" src="static/特征谱数据库/液相色谱法/特征谱/${LCInfo.featureMap}.jpg" width="500" height=auto >
                                ...
                                <div class="row">
                                    <div class="col-lg-10 col-lg-offset-1"><!--well-->
                                        ...
                                        <embed width="900" height="800" src="static/特征谱数据库/液相色谱法/参考文献/${LCInfo.featureMap}.pdf">
                                    </div>
                                </div>
                                <div>
                                </div>
