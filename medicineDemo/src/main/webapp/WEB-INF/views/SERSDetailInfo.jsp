...
<nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="wrapper wrapper-content">
            <div class="container">
                <br/>
                <h1 class="text-center "><strong>表面增强拉曼光谱法——${CNName}</strong></h1>
                <br/><br/>
                <div class="row">
                            ...
                            <div class="ibox-content">
                                ...
                                <div class="row">
                                    <div class="col-lg-10 col-lg-offset-1">
                                        ...
                                        <div class="col-lg-6">
                                            <table class="table" >
                                                ...
                                                <tr>
                                                    <th width="30%">【特征峰3】</th>
                                                    <td>
                                                        <span class="attr_value">${SERSInfo.charPeak3}</span>
                                        ...
                                        <div class="col-lg-5">
                                            <%--<ul id="imglist">--%>
                                                <%--<li> </li>--%>
                                                    <img id="spectrogram" src="static/特征谱数据库/表面增强拉曼光谱法/特征谱/${SERSInfo.featureMap}.jpg" width="500" height=auto >
                                ...
                                <div class="row">
                                    <div class="col-lg-10 col-lg-offset-1"><!--well-->
                                        ...
                                        <embed width="900" height="800" src="static/特征谱数据库/表面增强拉曼光谱法/参考文献/${SERSInfo.featureMap}.pdf">
                                    </div>
                                </div>
                                <div>
                                </div>
