									...
									<table class="table">
										...
										<tbody>
											<tr>
												...
												<td>${CNName}</td>
												<td>液相色谱法</td>
												<td>${LCInfo.detector}</td>
												<td>${LCInfo.excitationWL}</td>
												<td>${LCInfo.emissionWL}</td>
												<td>${LCInfo.chromatographicCol}</td>
												<td>${LCInfo.colTemperature}</td>
												<td>${LCInfo.mobilePhase}</td>
												<td>${LCInfo.flowRate}</td>
												<td>${LCInfo.injectionVolume}</td>
												<td>${LCInfo.pretreatmentMethod}</td>
												<td>${LCInfo.detectionLimit}</td>
												<td><a target="_blank"
													href="static/特征谱数据库/液相色谱法/特征图谱/${LCInfo.featureMap}.jpg">${LCInfo.featureMap}</a></td>
												<td><a target="_blank"
													href="static/特征谱数据库/液相色谱法/参考文献/${LCInfo.featureMap}.pdf">${LCInfo.reference}</a></td>
												<td>${LCInfo.samples}</td>
												<td>${LCInfo.otherDeterminants}</td>
											</tr>
										</tbody>
									</table>
									<!--
