...
<nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="wrapper wrapper-content">
            <div class="container">
                <br/>
                <h1 class="text-center "><strong>气相色谱质谱法——${CNName}</strong></h1>
                <br/><br/>
                <div class="row">
                            ...
                            <div class="ibox-content">
                                ...
                                <div class="row">
                                    <div class="col-lg-10 col-lg-offset-1">
                                        ...
                                        <div class="col-lg-6">
                                            <table class="table" >
                                                <tr>
                                                    <th width="30%">【电离方式】</th>
                                                    <td>
                                                        ${GCMSInfo.ionizationMode}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th width="30%">【色谱柱】</th>
                                                    <td>
                                                        ${GCMSInfo.chromatographicCol}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th width="30%">【测定方式】</th>
                                                    <td>
                                                        <span class="attr_value">${GCMSInfo.determinationMethod}</span>

                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th width="30%">【质量扫描范围】</th>
                                                    <td>
                                                        ${GCMSInfo.qualityScanRange}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th width="30%">【定量离子1】</th>
                                                    <td>
                                                        ${GCMSInfo.quantitativeIon1}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th width="30%">【定量离子2】</th>
                                                    <td>
                                                        ${GCMSInfo.quantitativeIon2}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th width="30%">【定量离子3】</th>
                                                    <td>
                                                        ${GCMSInfo.quantitativeIon3}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th width="30%">【定性离子1】</th>
                                                    <td>
                                                        ${GCMSInfo.qualitativeIon1}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th width="30%">【定性离子2】</th>
                                                    <td>
                                                        ${GCMSInfo.qualitativeIon2}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th width="30%">【定性离子3】</th>
                                                    <td>
                                                        ${GCMSInfo.qualitativeIon3}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th width="30%">【样品前处理】</th>
                                                    <td>
                                                        ${GCMSInfo.samplePreparation}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th width="30%">【检出限】</th>
                                                    <td>
                                                        ${GCMSInfo.detectionLimit}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th width="30%">【样品】</th>
                                        ...
                                        <div class="col-lg-5">
                                            <%--<ul id="imglist">--%>
                                                <%--<li> </li>--%>
                                                    <img id="spectrogram" src="static/特征谱数据库/气相色谱质谱法/特征谱/${GCMSInfo.featureMap}.jpg" width="500" height=auto >
                                ...
                                <div class="row">
                                    <div class="col-lg-10 col-lg-offset-1"><!--well-->
                                        ...
                                        <embed width="900" height="800" src="static/特征谱数据库/气相色谱质谱法/参考文献/${GCMSInfo.featureMap}.pdf">
                                    </div>
                                </div>
                                <div>
                                </div>
